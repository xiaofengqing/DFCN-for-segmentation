...
class Adaptive_Scale_Feature_Embedding(nn.Module):
    def __init__(self, embedding_dim, out_feature_dim):
        ...
        self.contxt_embedding_matrix = Parameter(
            torch.FloatTensor(self.attention_context_embedding_dim, self.out_feature_dim))
        self.context_embedding_bias = Parameter(torch.FloatTensor(self.out_feature_dim))
        self.cnn_feature_embedding_matrix = Parameter(
            torch.FloatTensor(self.original_feature_embedding_dim, self.out_feature_dim))
